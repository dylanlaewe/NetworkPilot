...
repository.native.exec("DROP TABLE IF EXISTS campaign_plan_lifecycle; DROP TABLE IF EXISTS campaign_plan_decisions; DROP TABLE IF EXISTS campaign_plans; DROP TABLE IF EXISTS drafts; DROP TABLE IF EXISTS personalization_evidence; DROP TABLE IF EXISTS fictional_targeting_profiles; DROP TABLE IF EXISTS fictional_company_profiles; DROP TABLE IF EXISTS target_companies; DROP TABLE IF EXISTS qualification_decisions; DROP TABLE IF EXISTS outreach_events; DROP TABLE IF EXISTS suppression_entries; DROP TABLE IF EXISTS simulation_runs; DROP TABLE IF EXISTS prospects; DROP TABLE IF EXISTS companies; DROP TABLE IF EXISTS campaign_settings; DROP TABLE IF EXISTS schema_migrations;");
repository.migrate();
