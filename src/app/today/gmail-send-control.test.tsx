...
describe("Gmail send confirmation",()=>{
  ...
  it("keeps Cancel non-submitting and exposes a keyboard-operable dismissible dialog",()=>{const html=renderToStaticMarkup(<GmailSendControl snapshotId="fixture" recipient="A*** R." company="Fictional Co" subject="A question" track="recruiter" action={()=>{}}/>);expect(html).toContain('popoverTarget="send-fixture"');expect(html).toContain('popoverTargetAction="hide"');expect(html).toContain('role="alertdialog"');});
});
