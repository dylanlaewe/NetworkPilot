  ...
  return <main className="product-shell review-page">
    ...
    <section className="review-layout">
      ...
      <form action={approveEditedDraft} className="message-editor">
        ...
        <label className="subject-field">Subject<input name="subject" defaultValue={review.subject} required maxLength={64}/></label><label className="body-field">Message<textarea name="body" defaultValue={review.body} required rows={14}/></label>
