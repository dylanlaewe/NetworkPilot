...
describe("draft persistence and fictional targeting profiles", () => {
  ...
  it("generates idempotent rotated drafts with explicit version snapshots", () => {
    ...
    expect(second[0]).toMatchObject({ templateVersion: "5.0.0", templateCatalogVersion: "catalog-v5-dylan-outreach-method-v2", scoreVersion: "targeting-v2", score: first[0].score, createdAt: "2026-09-07T16:00:00.000Z" });
