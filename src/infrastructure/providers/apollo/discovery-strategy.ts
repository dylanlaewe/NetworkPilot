...
export const BROAD_DISCOVERY_TITLES={
  analytics:["Data Analyst","Business Intelligence Analyst","Analytics Engineer","Business Analyst","Operations Analyst","Financial Analyst","Investment Analyst","Strategy Analyst","Consulting Analyst","Project Analyst","Program Analyst","Product Analyst"],
...
export function broadCompanyDiscoveryQueries():ApolloSearchOptions[]{return [
  {batchId:"broad-company-discovery-analytics",specificTitles:[...BROAD_DISCOVERY_TITLES.analytics],includeSimilarTitles:false,personLocations:northeastAndNational,perPage:25,page:1},
