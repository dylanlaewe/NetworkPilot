...
export interface ApolloHttpTransport {request(input:{path:"/api/v1/mixed_people/search"|"/api/v1/people/match";body:unknown;apiKey:string;timeoutMs:number;maxResponseBytes:number}):Promise<ApolloHttpResponse>;}
