...
export interface ApolloSearchResult {records:CandidateSourceRecord[];recordRejections?:ApolloProviderRecordRejection[];totalAvailable:number|null;requestVersion:string;}
