...
export const OUTREACH_EVENT_TYPES = ["qualified", "rejected", "selected", "drafted", "simulated-sent", "actually-sent", "operator-confirmed-manual-send", "operator-reported-hard-bounce", "replied", "suppressed", "cancelled"] as const;
