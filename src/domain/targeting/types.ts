...
export interface TargetCandidate { id: string; company: TargetCompany | null; role: TargetRole; persona: ContactPersona; industry: IndustryPreference; geographyScore: number; roleAlignment: number; functionalRelevance: number; yearsExperience: number; sharedSignal: number; dataQuality: number; roleSpecificUpside: number; }
