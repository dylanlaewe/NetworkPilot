...
export interface TargetCandidate { id: string; company: TargetCompany | null; role: TargetRole; preciseRoleId?:string|null; recipientRelevance?:{score:number;version:"recipient-relevance-v1"|"recipient-relevance-v2"}; persona: ContactPersona; industry: IndustryPreference; geographyScore: number; roleAlignment: number; functionalRelevance: number; yearsExperience: number; sharedSignal: number; dataQuality: number; roleSpecificUpside: number; }
