...
export interface CandidateSourceRecord {
  ...
  providerMetadata?:{adapterVersion:string;responseMappingVersion:string;requestContractVersion:string;importArchitectureVersion:string;providerSeniority?:string;identityEvidenceBasis?:"provider-native-id-exact";providerNativeRequestId?:string;providerNativeReturnedId?:string;matchConfidence?:"high"|"medium"|"low";responseStructure?:{topLevel:Record<string,string>;person:Record<string,string>}};
}
...
export interface NormalizedCandidateRecord {
  ...
  recipientRelevance?:{score:number;version:import("./recipient-function").RecipientRelevanceVersion;explanationCodes:string[]};
