...
export interface RecruiterDraft {outreachIntent:import("@/domain/drafting/outreach-intent").IntentSelection;track:"recruiter";subject:string;body:string;variant:"direct-introduction"|"early-career-alignment"|"technical-recruiting-alignment"|"general-internal-recruiter";wordCount:number;referencedEvidence:string[];catalogVersion:"recruiter-catalog-v7-dylan-outreach-method-v5";subjectVersion:"recruiter-subject-v7";}
